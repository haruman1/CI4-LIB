                        ...
                        <form class="text-start mt-4 " method="POST" action="/register">
                            ...
                            <div class=" row align-items-center g-4">
                                ...
                                <div class="col-12 mt-2 mt-sm-1">
                                    ...
                                    ?>
                                    <input class="form-control" type="email" placeholder="Email Address" aria-label="Email Address" name="register_email" id="register_email" value="<?= set_value('email_user') ?>" />
                                ...
                                <div class="col-12 mt-2 mt-sm-1">
                                    ...
                                    ?><input class="form-control" type="Password" placeholder="Confirm Password" aria-label="Confirm Password" name="register_confirmation_password" />
